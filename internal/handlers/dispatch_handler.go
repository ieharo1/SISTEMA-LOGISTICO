...
func (h *ProductHandler) CreateProduct(c *gin.Context) {
	...
	userID := c.MustGet("user_id").(primitive.ObjectID)
	created, err := h.productService.CreateProduct(c.Request.Context(), &product, userID)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *ProductHandler) AdjustStock(c *gin.Context) {
	...
	userID := c.MustGet("user_id").(primitive.ObjectID)
	if err := h.productService.AdjustStock(c.Request.Context(), id, req.Quantity, req.Reason, userID); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *OrderHandler) CreateOrder(c *gin.Context) {
	...
	userID := c.MustGet("user_id").(primitive.ObjectID)
	if err := h.orderService.CreateOrder(c.Request.Context(), &order, userID); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *OrderHandler) GetOrders(c *gin.Context) {
	...
	orders, total, err := h.orderService.GetOrders(c.Request.Context(), status, page, limit)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *OrderHandler) UpdateOrderStatus(c *gin.Context) {
	...
	if err := h.orderService.UpdateOrderStatus(c.Request.Context(), id, models.OrderStatus(req.Status)); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *OrderHandler) AssignDriver(c *gin.Context) {
	...
	if err := h.orderService.AssignDriver(c.Request.Context(), orderID, driverID); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *OrderHandler) GetStats(c *gin.Context) {
	stats, err := h.orderService.GetStats(c.Request.Context())
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *DriverHandler) CreateDriver(c *gin.Context) {
	...
	created, err := h.driverService.CreateDriver(c.Request.Context(), &driver)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *DriverHandler) GetDriver(c *gin.Context) {
	...
	driver, err := h.driverService.GetDriver(c.Request.Context(), id)
	if err != nil {
...
func (h *DriverHandler) UpdateDriver(c *gin.Context) {
	...
	if err := h.driverService.UpdateDriver(c.Request.Context(), &driver); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
